...
/******** Feed ********/
Adafruit_MQTT_Publish pubAlarma = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/detect");
Adafruit_MQTT_Publish pubTemp = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/temp");
Adafruit_MQTT_Publish pubHum  = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/humidity");
/******** Sensor FC-51 ********/
const int PIN_FC51 = 32;
